...
<template>
  <van-popup :show="show" round closeable position="bottom" :style="popupStyle" @update:show="updateShow">
    <div class="rate-header">Write Review</div>
    <div class="rate-body">
      <van-cell title="Please Rate" :border="false"></van-cell>
      <div class="rate-box">
      ...
      <van-field
        ...
        label="备注"
        type="textarea"
        placeholder="Good quality products!!！"
        maxlength="200"
        rows="1"
        autosize
      />
    ...
    <div class="rate-actions">
      <van-button type="primary" round block @click="onSubmit">Submit</van-button>
    </div>
  </van-popup>
</template>
