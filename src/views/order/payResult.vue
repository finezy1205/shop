...
<template>
  <div class="container container-full">
    <div class="result">
      ...
      <div class="result-bd">
        <div class="result-title">{{ orderInfo.isPay ? 'Payment Success' : 'Payment Failed' }}</div>
        <div class="result-title-sub">{{ orderInfo.isPay ? 'Thank You' : 'Please Try Again' }}</div>
      </div>
    </div>
    <div class="action">
      <van-button class="action-btn" @click="goOrder">View Order</van-button>
      <van-button class="action-btn" plain @click="goHome">Home</van-button>
    </div>
  </div>
</template>
