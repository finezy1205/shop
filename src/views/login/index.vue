...
<template>
  <div class="container">
    <div class="main">
      ...
      <div class="safe-tips">For your account security, please login with your phone number</div>
      <form class="form">
        <div class="form-item">
...
<!--          </template>-->
          <span class="check-type-btn" @click="goPage('register')">Register</span>
        </div>
      </div>
    </div>
<!--    <div class="footer">-->
