...
const toolList = ref<Recordable[]>([
  { icon: 'balance-o', title: 'My wallet', path: '/wallet' },
  { icon: 'point-gift-o', title: 'Rewards', path: '/integral/exchange' },
  { icon: 'coupon-o', title: 'Coupons', path: '/coupon' },
  { icon: 'location-o', title: 'Address', path: '/address' },
  { icon: 'setting-o', title: 'Setting', path: '/setting' },
  { icon: ICON_ART, title: 'Theme', path: '/theme' },
  { icon: ICON_DEVICE, title: 'Device', value: 'device' },
]);
  ...
  <div class="container">
    <div class="header">
      <div v-if="hasLogin" class="header-inner" @click="goPage('/profile')">
        <div class="header-tag">Informations</div>
      ...
      <div v-else class="header-inner" @click="goLogin">
        ...
        <div class="header-info">
          <div class="header-nick">Login</div>
        </div>
      </div>
      <div class="header-bg">
    ...
    <div class="main">
      ...
      <div class="group">
        <div class="group-header van-hairline--bottom" @click="goPage('/order/list')">
          <div class="group-header-hd">My Order</div>
          <div class="group-header-bd">
            <span class="group-header-txt">All</span>
      ...
      <div class="group">
        <div class="group-header van-hairline--bottom">
          <div class="group-header-hd">Setting</div>
        </div>
        <div class="tool-list">
