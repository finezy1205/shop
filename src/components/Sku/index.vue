...
<template>
  <van-popup :show="show" round closeable position="bottom" :style="popupStyle" @update:show="updateShow">
        ...
        <div class="sku-header-good-info-bd">
          <div class="sku-header-good-price">
            ...
            <span class="sku-header-good-price-integer">
              ...
              <span class="sku-header-item">{{ sku.goodInfo.unit || '件' }}</span>
            </span>
          </div>
          <div class="sku-header-item">
            stock <span class="sku-header-good-stock-num">{{ selectedSkuComb.stock }}</span>
          </div>
    ...
    <div class="sku-body">
      ...
      <div class="sku-num">
        <div class="sku-num-title">Quantity</div>
        <!-- eslint-disable-next-line vue/no-mutating-props -->
        <van-stepper v-model="initialSku.selectedNum" class="sku-num-stepper" />
      </div>
    </div>
    <div class="sku-actions">
      <van-button type="primary" round block @click="onSubmit">Confirm</van-button>
    </div>
  </van-popup>
</template>
